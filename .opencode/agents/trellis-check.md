...
- `trellisforge-trellis-review` Skill (`.opencode/skills/trellisforge-trellis-review/SKILL.md`) - authoritative five-level profile contract: `light`, `standard`, `reinforced`, `comprehensive`, `strict`
