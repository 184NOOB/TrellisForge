...
CUSTOM_MIRROR_PAIRS = (
    ...
    (
        ".agents/skills/trellisforge-trellis-grill-adapter/SKILL.md",
        ".opencode/skills/trellisforge-trellis-grill-adapter/SKILL.md",
    ),
    (
        ".agents/skills/trellisforge-trellis-review/SKILL.md",
        ".opencode/skills/trellisforge-trellis-review/SKILL.md",
    ),
...
class OpenCodeClosureStaticTests(unittest.TestCase):
    ...
    def test_agent_frontmatter_and_role_boundaries(self) -> None:
        ...
        self.assertIn("trellisforge-trellis-review", check)
    ...
    def test_bundled_check_skill_follows_five_level_contract(self) -> None:
        ...
        self.assertIn("trellisforge-trellis-review", text)
        for level in LEVELS:
        ...
        self.assertIn("installer smoke checks", text.lower())
        self.assertIn("downstream validation", text.lower())
    ...
    def test_no_stale_semantics_anywhere_in_opencode_tree(self) -> None:
        for path in OPENCODE.rglob("*"):
            ...
            for line in text.splitlines():
                ...
                self.assertNotIn("<trellisforge>", line, rel)
                self.assertNotIn("<TrellisForge>", line, rel)
