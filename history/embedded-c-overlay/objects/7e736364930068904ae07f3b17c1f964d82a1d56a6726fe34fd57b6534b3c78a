...
5. Run only project-defined affected static checks, tests, and target builds; report unavailable or inapplicable categories in the final message instead of inventing commands or recording false passes
